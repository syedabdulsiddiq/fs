...
// Function to select 25 random questions for FS1 IT exam
function selectFS1ITExamQuestions() {
    if (fs1itQuestionBank.length === 0) {
        console.error('FS1 IT question bank is empty!');
        return [];
    }
    
    let availableQuestions = [...fs1itQuestionBank];

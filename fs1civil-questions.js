// FS1 CIVIL Exam Questions - C Programming
// Total questions: 100 (same as FS1 CSE)
// Each student gets 25 random questions
// Exam duration: 30 minutes

let fs1civilQuestionBank = [
...
// Function to select 25 random questions for FS1 CIVIL exam
function selectFS1CIVILExamQuestions() {
    if (fs1civilQuestionBank.length === 0) {
        console.error('FS1 CIVIL question bank is empty!');
        return [];
    }
    
    let availableQuestions = [...fs1civilQuestionBank];

...
// Function to select 25 random questions for FS1 AIDS exam
function selectFS1AIDSExamQuestions() {
    if (fs1aidsQuestionBank.length === 0) {
        console.error('FS1 AIDS question bank is empty!');
        return [];
    }
    
    let availableQuestions = [...fs1aidsQuestionBank];
